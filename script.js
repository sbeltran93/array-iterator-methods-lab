...
let namess = person.split(", ")
return namess[1] + " " + namess[0]
})
...
// Enter your solution code here:
/*
totalYearsLived = inventors.reduce((1879, 1955) => {inventors.year - inventors.passed, totalYearsLived
});
*/

let ageCount = inventors.reduce(() => {
  return inventors.year - inventors.passed, totalYearsLived
});

/*
totalYearsLived = inventors.reduce((inventor) => {
